...
var (
	...
	Driver        = FlagSet.String("driver", "", "driver to use. (aws-dynamo, aws-sqs, cassandra, centauri, gcp-pubsub, local, mongodb, mysql, postgres, rabbitmq, redis-list, redis-pubsub)")
